package xyz.bluspring.unitytranslate.common.transcriber.browser

import com.sun.net.httpserver.HttpServer
import xyz.bluspring.unitytranslate.common.UnityTranslate

class BrowserApplication(val instance: UnityTranslate) {
    ...
    private fun applyTranslations(text: String): String {
        ...
        for ((id, key) in translationMap) {
            val translated = instance.proxy.getTranslation(key)
