...
interface ConfigBuilder {
    ...
    fun <T : NameProvidingEntry> dropdown(id: String, values: Collection<T>, codec: Codec<T>, property: KMutableProperty<T>, owner: Any? = null, builder: ConfigValueBuilder<T>.() -> Unit = {})
    fun <T> downloadableDropdown(id: String, values: Collection<T>, codec: Codec<T>, property: KMutableProperty<T>, owner: Any? = null, builder: ConfigValueBuilder<T>.() -> Unit = {}) where T : DownloadableEntry, T : NameProvidingEntry
