...
class WhisperTranscriber(instance: UnityTranslate, language: Language) : SpeechTranscriber(TranscriberType.WHISPER, instance, language) {
    ...
    init {
        ...
        ctx = whisper.init(whisperPath.resolve(UnityTranslateGui.clientConfig.whisperModel.fileName),
    ...
    companion object {
        ...
        fun isAvailable(): Boolean {
            ...
            if (!whisperPath.resolve(UnityTranslateGui.clientConfig.whisperModel.fileName).exists())
                return false
