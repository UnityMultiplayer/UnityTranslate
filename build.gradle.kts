...
subprojects {
    if (project.name == "minecraft" || project.name == "fabric" || project.name == "forge" || project.name == "neoforge" || project.name == "library" || project.parent?.name == "library" || project.name == "transcribers")
        return@subprojects
    ...
    dependencies {
        ...
        if (project.name != "transcribers" && project.parent?.name != "transcribers") {
